...
export default class bulmaCalendar extends EventEmitter {
  constructor(selector, options = {}) {
    ...
    this.element = type.isString(selector)
    ...
    this.onDocumentClickDateTimePicker =
      this.onDocumentClickDateTimePicker.bind(this)
    this.onValidateClickDateTimePicker =
      this.onValidateClickDateTimePicker.bind(this)
    ...
    this.onCancelClickDateTimePicker =
      this.onCancelClickDateTimePicker.bind(this)
    ...
    this.onChangeStartMinutesManually =
      this.onChangeStartMinutesManually.bind(this)
  ...
  static attach(selector = 'input[type="date"]', options = {}) {
    ...
    const elements = type.isString(selector)
      ...
      if (this.options.type == 'datetime') {
        if (this.options.isRange) {
          ...
          if (Array.isArray(value)) {
            ...
            if (value.length === 2)
              value[1] = utils.newDate(value[1], this.format)
          }
        } else {
          if (type.isString(value)) {
    ...
    switch (this.options.type) {
      ...
      case 'datetime':
        ...
        if (this.options.isRange) {
          ...
          string += ` - ${
            end ? dateFns.format(end, this.format, { locale: this.locale }) : ''
          }`
        }
  ...
  refresh() {
    this._ui.header.start.day.innerHTML = this.datePicker.start
      ? dateFns.format(this.datePicker.start, 'dd', { locale: this.locale })
      : '-'
    this._ui.header.start.month.innerHTML = this.datePicker.start
      ? dateFns.format(this.datePicker.start, this.options.formats.header, {
          locale: this.locale
        })
      : ''
    ...
    if (this.datePicker.start) {
      ...
      this._ui.header.start.weekday.innerHTML = this.datePicker.start
        ? dateFns.format(this.datePicker.start, 'EEEE', { locale: this.locale })
        : ''
    } else {
    ...
    if (this._ui.header.start.hour) {
      if (this.options.editTimeManually) {
        this._ui.header.start.inputHours.value = this.timePicker.start
          ? dateFns.format(this.timePicker.start, 'HH', { locale: this.locale })
          : '--'
        this._ui.header.start.inputMinutes.value = this.timePicker.start
          ? dateFns.format(this.timePicker.start, 'mm', { locale: this.locale })
          : '--'
      } else {
    ...
    if (this._ui.header.end) {
      this._ui.header.end.day.innerHTML =
        this.options.isRange && this.datePicker.end
          ? dateFns.format(this.datePicker.end, 'dd', { locale: this.locale })
          : '-'

      this._ui.header.end.month.innerHTML =
        this.options.isRange && this.datePicker.end
          ? dateFns.format(this.datePicker.end, this.options.formats.header, {
              locale: this.locale
            })
          : ''
      ...
      if (this.datePicker.end) {
        ...
        this._ui.header.end.weekday.innerHTML = this.datePicker.end
          ? dateFns.format(this.datePicker.end, 'EEEE', { locale: this.locale })
          : ''
      } else {
      ...
      if (this._ui.header.end && this._ui.header.end.hour) {
        if (this.options.editTimeManually) {
          this._ui.header.end.inputHours.value = this.timePicker.end
            ? dateFns.format(this.timePicker.end, 'HH', { locale: this.locale })
            : '--'
          this._ui.header.end.inputMinutes.value = this.timePicker.end
            ? dateFns.format(this.timePicker.end, 'mm', { locale: this.locale })
            : '--'
        } else {
  ...
  _build() {
    ...
    this._ui.container.appendChild(footerNode)
  ...
  _refreshInput() {
    ...
    this._ui.dummy.dummy_1.value = this.options.dateFormater(start)

    if (this._ui.dummy.dummy_2) {
      this._ui.dummy.dummy_2.value = this.options.dateFormater(end)
    }
