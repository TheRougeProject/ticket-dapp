  ...
  {:else}
        ...
        <ul>
          ...
          <li>
            Join us <a
              rel="noreferrer"
              target="_blank"
              href="https://discord.gg/aUeSjsN8Tx">on Discord</a> for feedback, bug
            reports and help.
          </li>
        </ul>
      </div>
    ...
    {#if $signerAddress}
      <EmptyState svg="/bad-connection.svg">
        ...
        {/each}
        <p class="help is-info">
          This app in still beta and we only support a few networks for now. Do
          you want us to support {$chainData.name} in the future, let us know in
          our discord.
        </p>
      </EmptyState>
    {:else}
      <EmptyState svg="/bad-connection.svg">
        ...
        <p class="help is-info">
          In order to view your events or create an event, you need to connect.
        </p>
      </EmptyState>
    {/if}
  {/if}
